...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RestauranteDB`.`Users` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RestauranteDB`.`Admins` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RestauranteDB`.`Enderecos` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RestauranteDB`.`Pedidos` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RestauranteDB`.`Tipo_Produtos` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RestauranteDB`.`Produtos` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RestauranteDB`.`User_Infos` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `RestauranteDB`.`Pedido_Produtos` ;
...
START TRANSACTION;
USE `RestauranteDB`;
INSERT INTO `RestauranteDB`.`Produtos` (`id`, `nome`, `preco`, `Tipo_Produtos_id`, `ingredientes`, `urlImage`, `updated_at`, `created_at`) VALUES (1, 'Pepperoni', 50.50, 1, 'Pepperoni fatiado, queijo, cebola, pimentão, molho de tomate e orégano', '/img-default/pepperoni-2024-10-17-1729213779-2727.png', '2024-07-25 22:00:00', '2024-07-25 22:00:00');
INSERT INTO `RestauranteDB`.`Produtos` (`id`, `nome`, `preco`, `Tipo_Produtos_id`, `ingredientes`, `urlImage`, `updated_at`, `created_at`) VALUES (2, 'Laranja', 8.00, 2, 'Laranja, água e açucar', '/img-default/laranja-2024-10-17-1729213779-2727.png', '2024-07-25 22:00:00', '2024-07-25 22:00:00');
INSERT INTO `RestauranteDB`.`Produtos` (`id`, `nome`, `preco`, `Tipo_Produtos_id`, `ingredientes`, `urlImage`, `updated_at`, `created_at`) VALUES (3, 'Skol - Lata', 8.00, 3, 'Água, malte, milho e lúpulo. Alergênicos: Contém cevada e glúten', '/img-default/skol-lata-2024-10-17-1729213779-2727.png', '2024-07-25 22:00:00', '2024-07-25 22:00:00');
